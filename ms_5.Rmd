...
I'd like to find a way to visualize this data more clearly (probably by breaking this plot into multiple smaller plots, e.g. by team or season), but this will do for a start. I joined data on playoff performance with data on team payroll to produce the following results. I'm intrigued by the few easons where the top-performing teams are at the top of the payroll scale (1984-85, 1988-90, 1996-99, 2016-18) and also interested in the high-paying teams that *failed* to make the playoffs in the years 2002-2009.
