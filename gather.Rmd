...
# note: may need to filter to remove salary groups not belonging to teams (e.g.
# "Pool", "Retired", "Major League Soccer", etc.) - find break point by
# arranging to find lowest total that actually reflected a proper team payroll
# and lopping off everything below that cutoff (also note that FC Cincinati in
# 2018 has higher salary than breakoff point)
